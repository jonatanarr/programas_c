...
void EnableADC(){
	...
	NVIC_SetPriority(ADC0_IRQn , 31); //Fijo baja prioridad al ADCO;
	NVIC_EnableIRQ(ADC0_IRQn);	//Habilito Interrupciones ADC0 en el micro
...
void EnablePIT(){
	...
	//		PIT_LDVAL0 |= PIT_LDVAL_TSV(1249999);
